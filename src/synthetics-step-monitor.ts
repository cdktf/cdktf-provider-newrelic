// https://www.terraform.io/docs/providers/newrelic/r/synthetics_step_monitor
...
export interface SyntheticsStepMonitorConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly locationsPrivate?: SyntheticsStepMonitorLocationsPrivate[] | cdktf.IResolvable;
  /**
  * steps block
  * 
...
export interface SyntheticsStepMonitorLocationsPrivate {
  /**
...
export function syntheticsStepMonitorLocationsPrivateToTerraform(struct?: SyntheticsStepMonitorLocationsPrivate | cdktf.IResolvable): any {
...
export class SyntheticsStepMonitorLocationsPrivateOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SyntheticsStepMonitorLocationsPrivate | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SyntheticsStepMonitorLocationsPrivate | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SyntheticsStepMonitorLocationsPrivateList extends cdktf.ComplexList {
  public internalValue? : SyntheticsStepMonitorLocationsPrivate[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SyntheticsStepMonitorLocationsPrivateOutputReference {
    return new SyntheticsStepMonitorLocationsPrivateOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SyntheticsStepMonitor extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: SyntheticsStepMonitorConfig) {
    ...
    this._locationsPrivate.internalValue = config.locationsPrivate;
  ...
  private _locationsPrivate = new SyntheticsStepMonitorLocationsPrivateList(this, "locations_private", true);
  public get locationsPrivate() {
    return this._locationsPrivate;
  }
  public putLocationsPrivate(value: SyntheticsStepMonitorLocationsPrivate[] | cdktf.IResolvable) {
    this._locationsPrivate.internalValue = value;
  }
  public resetLocationsPrivate() {
    this._locationsPrivate.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get locationsPrivateInput() {
    return this._locationsPrivate.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      locations_private: cdktf.listMapper(syntheticsStepMonitorLocationsPrivateToTerraform, true)(this._locationsPrivate.internalValue),
