// https://registry.terraform.io/providers/newrelic/newrelic/3.52.1/docs/resources/cloud_aws_integrations
...
export class CloudAwsIntegrations extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudAwsIntegrations that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.52.1/docs/resources/cloud_aws_integrations#import import section} in the documentation of this resource for the id to use
