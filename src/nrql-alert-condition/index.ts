...
// https://registry.terraform.io/providers/newrelic/newrelic/3.69.1/docs/resources/nrql_alert_condition
...
export class NrqlAlertConditionCriticalOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _disableHealthStatusReporting?: boolean | cdktf.IResolvable; 
  public get disableHealthStatusReporting() {
    return this.getBooleanAttribute('disable_health_status_reporting');
  }
  public set disableHealthStatusReporting(value: boolean | cdktf.IResolvable) {
    this._disableHealthStatusReporting = value;
  }
  public resetDisableHealthStatusReporting() {
    this._disableHealthStatusReporting = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get disableHealthStatusReportingInput() {
...
export class NrqlAlertCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NrqlAlertCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.69.1/docs/resources/nrql_alert_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.69.1/docs/resources/nrql_alert_condition newrelic_nrql_alert_condition} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _signalSeasonality?: string; 
  public get signalSeasonality() {
    return this.getStringAttribute('signal_seasonality');
  }
  public set signalSeasonality(value: string) {
    this._signalSeasonality = value;
  }
  public resetSignalSeasonality() {
    this._signalSeasonality = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get signalSeasonalityInput() {
