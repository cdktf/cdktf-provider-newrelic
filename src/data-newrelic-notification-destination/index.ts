...
// https://registry.terraform.io/providers/newrelic/newrelic/3.27.6/docs/data-sources/notification_destination
...
export class DataNewrelicNotificationDestination extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicNotificationDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.27.6/docs/data-sources/notification_destination#import import section} in the documentation of this resource for the id to use
