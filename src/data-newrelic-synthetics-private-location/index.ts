...
// https://registry.terraform.io/providers/newrelic/newrelic/3.70.2/docs/data-sources/synthetics_private_location
...
export class DataNewrelicSyntheticsPrivateLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicSyntheticsPrivateLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.70.2/docs/data-sources/synthetics_private_location#import import section} in the documentation of this resource for the id to use
