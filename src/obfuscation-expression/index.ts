...
// https://registry.terraform.io/providers/newrelic/newrelic/3.60.2/docs/resources/obfuscation_expression
...
export class ObfuscationExpression extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObfuscationExpression that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.60.2/docs/resources/obfuscation_expression#import import section} in the documentation of this resource for the id to use
