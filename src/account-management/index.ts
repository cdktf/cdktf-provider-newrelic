...
// https://registry.terraform.io/providers/newrelic/newrelic/3.65.0/docs/resources/account_management
...
export class AccountManagement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.65.0/docs/resources/account_management#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.65.0/docs/resources/account_management newrelic_account_management} Resource
  *
  * @param scope The scope in which to define this construct
