...
// https://registry.terraform.io/providers/newrelic/newrelic/3.64.0/docs/resources/data_partition_rule
...
export class DataPartitionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataPartitionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.64.0/docs/resources/data_partition_rule#import import section} in the documentation of this resource for the id to use
