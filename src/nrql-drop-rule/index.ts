...
// https://registry.terraform.io/providers/newrelic/newrelic/3.70.0/docs/resources/nrql_drop_rule
...
export class NrqlDropRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NrqlDropRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.70.0/docs/resources/nrql_drop_rule#import import section} in the documentation of this resource for the id to use
