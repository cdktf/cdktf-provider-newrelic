...
// https://registry.terraform.io/providers/newrelic/newrelic/3.61.3/docs/resources/synthetics_private_location
...
export class SyntheticsPrivateLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsPrivateLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.61.3/docs/resources/synthetics_private_location#import import section} in the documentation of this resource for the id to use
