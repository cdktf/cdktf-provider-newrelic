...
// https://registry.terraform.io/providers/newrelic/newrelic/3.60.2/docs/resources/one_dashboard_json
...
export class OneDashboardJson extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OneDashboardJson that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.60.2/docs/resources/one_dashboard_json#import import section} in the documentation of this resource for the id to use
