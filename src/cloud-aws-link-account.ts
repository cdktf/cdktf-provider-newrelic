...
export class CloudAwsLinkAccount extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "newrelic_cloud_aws_link_account";
  ...
  */
  ...
  private _timeouts = new CloudAwsLinkAccountTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
