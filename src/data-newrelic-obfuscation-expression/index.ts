...
// https://registry.terraform.io/providers/newrelic/newrelic/3.70.2/docs/data-sources/obfuscation_expression
...
export class DataNewrelicObfuscationExpression extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicObfuscationExpression that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.70.2/docs/data-sources/obfuscation_expression#import import section} in the documentation of this resource for the id to use
