...
// https://registry.terraform.io/providers/newrelic/newrelic/3.54.0/docs/resources/service_level
...
export class ServiceLevel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLevel that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.54.0/docs/resources/service_level#import import section} in the documentation of this resource for the id to use
