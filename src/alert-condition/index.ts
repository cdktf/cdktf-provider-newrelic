// https://registry.terraform.io/providers/newrelic/newrelic/3.25.1/docs/resources/alert_condition
...
export interface AlertConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Automatically close instance-based incidents, including JVM health metric incidents, after the number of hours specified. Must be between 1 and 720 hours. Defaults to 72.
  * 
...
export class AlertCondition extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.25.1/docs/resources/alert_condition newrelic_alert_condition} Resource
  *
