// https://www.terraform.io/docs/providers/newrelic/r/workflow
...
export interface WorkflowConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly workflowEnabled?: boolean | cdktf.IResolvable;
  /**
  ...
  */
  readonly destinationConfiguration: WorkflowDestinationConfiguration[] | cdktf.IResolvable;
  /**
  * enrichments block
  * 
...
export function workflowDestinationConfigurationToTerraform(struct?: WorkflowDestinationConfiguration | cdktf.IResolvable): any {
...
export class WorkflowDestinationConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WorkflowDestinationConfiguration | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: WorkflowDestinationConfiguration | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class WorkflowDestinationConfigurationList extends cdktf.ComplexList {
  public internalValue? : WorkflowDestinationConfiguration[] | cdktf.IResolvable
  ...
  */
  public get(index: number): WorkflowDestinationConfigurationOutputReference {
    return new WorkflowDestinationConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface WorkflowEnrichmentsNrqlConfigurations {
  /**
...
export function workflowEnrichmentsNrqlConfigurationsToTerraform(struct?: WorkflowEnrichmentsNrqlConfigurations | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class WorkflowEnrichmentsNrqlConfigurationsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): WorkflowEnrichmentsNrqlConfigurations | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: WorkflowEnrichmentsNrqlConfigurations | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class WorkflowEnrichmentsNrqlConfigurationsList extends cdktf.ComplexList {
  public internalValue? : WorkflowEnrichmentsNrqlConfigurations[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): WorkflowEnrichmentsNrqlConfigurationsOutputReference {
    return new WorkflowEnrichmentsNrqlConfigurationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface WorkflowEnrichmentsNrql {
  ...
  */
  readonly configurations: WorkflowEnrichmentsNrqlConfigurations[] | cdktf.IResolvable;
}
...
export function workflowEnrichmentsNrqlToTerraform(struct?: WorkflowEnrichmentsNrql | cdktf.IResolvable): any {
  ...
  return {
    ...
    configurations: cdktf.listMapper(workflowEnrichmentsNrqlConfigurationsToTerraform, true)(struct!.configurations),
  }
}
...
export class WorkflowEnrichmentsNrqlOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _configurations = new WorkflowEnrichmentsNrqlConfigurationsList(this, "configurations", false);
  public get configurations() {
    return this._configurations;
  }
  public putConfigurations(value: WorkflowEnrichmentsNrqlConfigurations[] | cdktf.IResolvable) {
...
export interface WorkflowIssuesFilterPredicates {
  /**
...
export function workflowIssuesFilterPredicatesToTerraform(struct?: WorkflowIssuesFilterPredicates | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class WorkflowIssuesFilterPredicatesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): WorkflowIssuesFilterPredicates | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: WorkflowIssuesFilterPredicates | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class WorkflowIssuesFilterPredicatesList extends cdktf.ComplexList {
  public internalValue? : WorkflowIssuesFilterPredicates[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): WorkflowIssuesFilterPredicatesOutputReference {
    return new WorkflowIssuesFilterPredicatesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface WorkflowIssuesFilter {
  ...
  */
  readonly predicates?: WorkflowIssuesFilterPredicates[] | cdktf.IResolvable;
}
...
export function workflowIssuesFilterToTerraform(struct?: WorkflowIssuesFilterOutputReference | WorkflowIssuesFilter): any {
  ...
  return {
    ...
    predicates: cdktf.listMapper(workflowIssuesFilterPredicatesToTerraform, true)(struct!.predicates),
  }
}
...
export class WorkflowIssuesFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _predicates = new WorkflowIssuesFilterPredicatesList(this, "predicates", false);
  public get predicates() {
    return this._predicates;
  }
  public putPredicates(value: WorkflowIssuesFilterPredicates[] | cdktf.IResolvable) {
...
export class Workflow extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: WorkflowConfig) {
    ...
    this._workflowEnabled = config.workflowEnabled;
  ...
  // workflow_enabled - computed: false, optional: true, required: false
  private _workflowEnabled?: boolean | cdktf.IResolvable; 
  public get workflowEnabled() {
    return this.getBooleanAttribute('workflow_enabled');
  }
  public set workflowEnabled(value: boolean | cdktf.IResolvable) {
    this._workflowEnabled = value;
  }
  public resetWorkflowEnabled() {
    this._workflowEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get workflowEnabledInput() {
  ...
  private _destinationConfiguration = new WorkflowDestinationConfigurationList(this, "destination_configuration", true);
  public get destinationConfiguration() {
    return this._destinationConfiguration;
  }
  public putDestinationConfiguration(value: WorkflowDestinationConfiguration[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      workflow_enabled: cdktf.booleanToTerraform(this._workflowEnabled),
      destination_configuration: cdktf.listMapper(workflowDestinationConfigurationToTerraform, true)(this._destinationConfiguration.internalValue),
