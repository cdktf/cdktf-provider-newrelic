...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/notificationchannel"
...
| <code><a href="#@cdktf/provider-newrelic.notificationChannel.NotificationChannelConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.25.2/docs/resources/notification_channel#id NotificationChannel#id}. |
