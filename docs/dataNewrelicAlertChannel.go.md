...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/datanewrelicalertchannel"
...
| <code><a href="#@cdktf/provider-newrelic.dataNewrelicAlertChannel.DataNewrelicAlertChannelConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.25.0/docs/data-sources/alert_channel#id DataNewrelicAlertChannel#id}. |
