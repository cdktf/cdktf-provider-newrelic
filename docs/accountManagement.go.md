...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v8/accountmanagement"
...
&accountmanagement.AccountManagementConfig {
	...
	Region: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v8.accountManagement.AccountManagementTimeouts,
}
```
