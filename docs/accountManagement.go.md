...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v7/accountmanagement"
...
&accountmanagement.AccountManagementConfig {
	...
	Region: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v7.accountManagement.AccountManagementTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-newrelic.accountManagement.AccountManagementConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.23.0/docs/resources/account_management#id AccountManagement#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-newrelic.accountManagement.AccountManagementTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.23.0/docs/resources/account_management#create AccountManagement#create}. |
