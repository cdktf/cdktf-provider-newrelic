...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v11/accountmanagement"
...
| <code><a href="#@cdktf/provider-newrelic.accountManagement.AccountManagementConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.27.2/docs/resources/account_management#id AccountManagement#id}. |
