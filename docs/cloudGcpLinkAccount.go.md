...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/cloudgcplinkaccount"
...
| <code><a href="#@cdktf/provider-newrelic.cloudGcpLinkAccount.CloudGcpLinkAccountConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.25.1/docs/resources/cloud_gcp_link_account#id CloudGcpLinkAccount#id}. |
