...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v8/infraalertcondition"
...
&infraalertcondition.InfraAlertConditionConfig {
	...
	Type: *string,
	Comparison: *string,
	Critical: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v8.infraAlertCondition.InfraAlertConditionCritical,
	Description: *string,
	Enabled: interface{},
	Event: *string,
	Id: *string,
	...
	Warning: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v8.infraAlertCondition.InfraAlertConditionWarning,
	Where: *string,
}
```
