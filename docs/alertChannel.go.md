...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v8/alertchannel"
...
&alertchannel.AlertChannelConfig {
	...
	Type: *string,
	AccountId: *f64,
	Config: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v8.alertChannel.AlertChannelConfigA,
	Id: *string,
}
```
