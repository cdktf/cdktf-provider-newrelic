...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/alertchannel"
...
&alertchannel.AlertChannelConfig {
	...
	Type: *string,
	AccountId: *f64,
	Config: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9.alertChannel.AlertChannelConfigA,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-newrelic.alertChannel.AlertChannelConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.25.1/docs/resources/alert_channel#id AlertChannel#id}. |
