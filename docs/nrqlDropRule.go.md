...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/nrqldroprule"
...
| <code><a href="#@cdktf/provider-newrelic.nrqlDropRule.NrqlDropRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.25.1/docs/resources/nrql_drop_rule#id NrqlDropRule#id}. |
