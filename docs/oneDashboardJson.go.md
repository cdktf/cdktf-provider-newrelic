...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/onedashboardjson"
...
&onedashboardjson.OneDashboardJsonConfig {
	...
	AccountId: *f64,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9.oneDashboardJson.OneDashboardJsonTimeouts,
}
```
