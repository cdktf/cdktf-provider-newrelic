...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/entitytags"
...
&entitytags.EntityTagsConfig {
	...
	Tag: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9.entityTags.EntityTagsTimeouts,
}
```
