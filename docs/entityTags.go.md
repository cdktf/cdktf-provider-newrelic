...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v13/entitytags"
...
&entitytags.EntityTagsConfig {
	...
	Tag: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v13.entityTags.EntityTagsTimeouts,
}
```
