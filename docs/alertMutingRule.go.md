...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10/alertmutingrule"
...
&alertmutingrule.AlertMutingRuleConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.alertMutingRule.AlertMutingRuleCondition,
	Enabled: interface{},
	Name: *string,
	AccountId: *f64,
	Description: *string,
	Id: *string,
	Schedule: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.alertMutingRule.AlertMutingRuleSchedule,
}
```
