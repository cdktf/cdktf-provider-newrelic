...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/alertmutingrule"
...
&alertmutingrule.AlertMutingRuleConfig {
	...
	Condition: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9.alertMutingRule.AlertMutingRuleCondition,
	Enabled: interface{},
	Name: *string,
	AccountId: *f64,
	Description: *string,
	Id: *string,
	Schedule: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9.alertMutingRule.AlertMutingRuleSchedule,
}
```
