...
| <code><a href="#@cdktf/provider-newrelic.syntheticsSecureCredential.SyntheticsSecureCredential.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly timeoutsInput: SyntheticsSecureCredentialTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-newrelic.syntheticsSecureCredential.SyntheticsSecureCredentialTimeouts">SyntheticsSecureCredentialTimeouts</a> | cdktf.IResolvable
...
| <code><a href="#@cdktf/provider-newrelic.syntheticsSecureCredential.SyntheticsSecureCredentialConfig.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly internalValue: SyntheticsSecureCredentialTimeouts | IResolvable;
```
