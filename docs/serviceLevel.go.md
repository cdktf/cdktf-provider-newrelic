...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10/servicelevel"
...
&servicelevel.ServiceLevelConfig {
	...
	Events: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelEvents,
	Guid: *string,
	Name: *string,
	Objective: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelObjective,
	Description: *string,
	Id: *string,
}
```
...
&servicelevel.ServiceLevelEvents {
	AccountId: *f64,
	ValidEvents: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelEventsValidEvents,
	BadEvents: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelEventsBadEvents,
	GoodEvents: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelEventsGoodEvents,
}
```
...
&servicelevel.ServiceLevelEventsBadEvents {
	From: *string,
	Select: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelEventsBadEventsSelect,
	Where: *string,
}
```
...
&servicelevel.ServiceLevelEventsGoodEvents {
	From: *string,
	Select: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelEventsGoodEventsSelect,
	Where: *string,
}
```
...
&servicelevel.ServiceLevelEventsValidEvents {
	From: *string,
	Select: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelEventsValidEventsSelect,
	Where: *string,
}
```
...
&servicelevel.ServiceLevelObjective {
	Target: *f64,
	TimeWindow: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelObjectiveTimeWindow,
	Description: *string,
	Name: *string,
}
```
...
&servicelevel.ServiceLevelObjectiveTimeWindow {
	Rolling: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v10.serviceLevel.ServiceLevelObjectiveTimeWindowRolling,
}
```
