...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v13/eventstometricsrule"
...
| <code><a href="#@cdktf/provider-newrelic.eventsToMetricsRule.EventsToMetricsRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/events_to_metrics_rule#id EventsToMetricsRule#id}. |
