...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v7/datapartitionrule"
...
| <code><a href="#@cdktf/provider-newrelic.dataPartitionRule.DataPartitionRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datapartitionrule.DataPartitionRuleConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v7.dataPartitionRule.DataPartitionRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-newrelic.dataPartitionRule.DataPartitionRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
