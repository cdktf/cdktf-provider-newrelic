...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/datapartitionrule"
...
&datapartitionrule.DataPartitionRuleConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9.dataPartitionRule.DataPartitionRuleTimeouts,
}
```
