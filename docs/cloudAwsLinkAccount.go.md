...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v11/cloudawslinkaccount"
...
| <code><a href="#@cdktf/provider-newrelic.cloudAwsLinkAccount.CloudAwsLinkAccountConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.27.7/docs/resources/cloud_aws_link_account#id CloudAwsLinkAccount#id}. |
