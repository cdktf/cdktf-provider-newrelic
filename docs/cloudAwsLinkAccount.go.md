...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/cloudawslinkaccount"
...
&cloudawslinkaccount.CloudAwsLinkAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9.cloudAwsLinkAccount.CloudAwsLinkAccountTimeouts,
}
```
