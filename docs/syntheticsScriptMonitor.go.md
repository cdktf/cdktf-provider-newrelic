...
```go
import "github.com/cdktf/cdktf-provider-newrelic-go/newrelic/v9/syntheticsscriptmonitor"
...
| <code><a href="#@cdktf/provider-newrelic.syntheticsScriptMonitor.SyntheticsScriptMonitorConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.25.1/docs/resources/synthetics_script_monitor#id SyntheticsScriptMonitor#id}. |
